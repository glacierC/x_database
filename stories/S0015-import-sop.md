...
> ⚠️ **2026-03-09 更新**：staging_eval 自动化流程暂停。原因：无头浏览器采集上限 ~1300 条/小时，当前 212 账号已接近合理上限，扩量需求未明确。代码（staging_eval.py / scheduler.py 48h job）保留，如需重启在此 story 基础上创建 S0017。
